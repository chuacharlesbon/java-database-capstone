...
The application interacts with two databases—MySQL (for structured data such as patient, doctor, appointment, and admin data) and MongoDB (for document-based and JSON data such as prescriptions).
